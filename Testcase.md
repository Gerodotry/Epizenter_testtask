...
| 2  | Авторизація               | Акаунт створено                 | <table><tr><td>1. Відкрити сторінку входу</td></tr><tr><td>2. Ввести email і пароль</td></tr><tr><td>3. Натиснути "Увійти"</td></tr></table>                 | Вхід виконано, відкривається головна сторінка                  |
...
| 4  | Додавання товару                     | База даних містить товари       | <table><tr><td>1. Ввести назву товару в пошук</td></tr><tr><td>2. Натиснути "Знайти"</td></tr></table>                                                       | Відображається список релевантних товарів                      |
